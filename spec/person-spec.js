...
describe('Person', function() {
  ...
  it('has a national identity', function() {
    expect(eiki.national_identity).toEqual(undefined);
    expect(ahishakiye.national_identity).toEqual('HUTU');
  });

  it('has a summary', function() {
    expect(eiki.summary).toEqual(undefined);
  ...
  describe('link', function() {
    ...
    it('returns nothing if no type', function() {
      expect(eiki.link('foo')).toEqual(undefined);
    });
  ...
  describe('contact', function() {
    ...
    it('returns nothing if no type', function() {
      expect(eiki.contact('foo')).toEqual(undefined);
    });
  ...
  it('has a patronymic name', function() {
    expect(eiki.patronymic_name).toEqual(undefined);
    expect(aaisha.patronymic_name).toEqual('d/o Shams-ul-Qayum Wazir');
  });

  it('has identifiers', function() {
    var identifier = { identifier: '81aecc23-8483-48d6-9217-289fce86b1b5', scheme: 'everypolitician_legacy'};
  ...
  it('has other names', function() {
    ...
    expect(eiki.other_names.length).toEqual(24);
